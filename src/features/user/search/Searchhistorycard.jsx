...
function SearchHistoryCard({ item, onViewResult }) {
  ...
  return (
    <div className="group bg-light rounded-xl sm:rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
      {/* Header */}
      <div className={`${statusInfo.headerBg} px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between`}>
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="p-1.5 sm:p-2 bg-light/20 rounded-md sm:rounded-lg">
            {renderIcon()}
          </div>
          <div>
            ...
            <p className="text-light/80 text-[10px] sm:text-xs font-medium mt-0.5">
              ID: #{item.id}
            </p>
          </div>
        </div>
        <div className="text-right">
          ...
          <p className="text-light/70 text-[10px] sm:text-xs">
            {time}
          </p>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 sm:gap-6 mb-4 sm:mb-6">
          <div className="flex-1">
            <p className="text-[10px] sm:text-xs font-bold text-dark-bg uppercase tracking-wider mb-1">
              Service
            </p>
          ...
          <div className="flex-1 sm:text-right">
            ...
            <p className="font-mono font-medium text-sm sm:text-lg text-gray-700 bg-gray-50 inline-block px-2 sm:px-3 py-1 rounded-md sm:rounded-lg border border-gray-100">
