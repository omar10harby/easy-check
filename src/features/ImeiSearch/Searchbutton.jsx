...
function SearchButton({ onClick, disabled, selectedServicePrice }) {
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 px-5 sm:px-6 py-4 sm:py-5 bg-primary text-light hover:bg-primary/90 hover:text-light/90 disabled:bg-medium-gray disabled:text-light disabled:cursor-not-allowed font-black text-lg rounded-2xl transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-95 disabled:hover:scale-100 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
    >
      <span>Check Now</span>
