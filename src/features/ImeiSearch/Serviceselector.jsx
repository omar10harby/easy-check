  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        >
          {selectedService ? (
            <div className="flex items-center justify-between w-full px-8 sm:px-10">
              <X
                className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 cursor-pointer text-dark-bg z-10 shrink-0"
                onClick={handleClear}
              />
              <div className="flex flex-1 items-center justify-between gap-3 overflow-hidden">
                <p className="font-semibold text-primary text-[13px] sm:text-base leading-tight text-left break-words">
