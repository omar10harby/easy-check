...
function ServiceInfoBox({ service }) {
  ...
  return (
    <div className="bg-linear-to-br from-primary/5 to-primary/10 border-2 border-primary/20 rounded-2xl p-4 animate-in fade-in slide-in-from-top-2 duration-300">
      {/* Header with Price */}
      ...
      {service.description ? (
        <div className="bg-white/50 rounded-xl p-3">
          <p className="text-xs text-primary/80 leading-relaxed whitespace-pre-line">
            {service.description}
          </p>
        </div>
      ) : (
