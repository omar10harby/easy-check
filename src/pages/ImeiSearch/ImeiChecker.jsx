...
function ImeiChecker() {
  ...
  const handleCheck = async () => {
    ...
    if(isAuthenticated){
      ...
      try {
          const res=await createGuestPayment(checkData)
  ...
  const isSearchDisabled = !selectedService || (inputType === 'imei' && imeiOrSerial.length !== 15) || (inputType === 'serial' && imeiOrSerial.length <8);
